...
var GitHubAPI = /** @class */ (function () {
    function GitHubAPI(repoMetadata, token) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, allComments
                                ...
                                .filter(function (comment) { return voca_1.default.includes(comment.body, githubIssueTemplate_1.dangerSignature); }) // Does it look like a danger message?
        ...
        this.updateStatus = function (passed, message, url) { return __awaiter(_this, void 0, void 0, function () {
            var repo, prJSON, ref, state, res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repo = this.repoMetadata.repoSlug;
