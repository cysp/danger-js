        ...
        this.getStructuredDiffForFile = function (base, head, filename) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repoSlug = this.repoMetadata.repoSlug;
                        path = "rest/api/1.0/" + repoSlug + "/compare/diff/" + filename + "?withComments=false&from=" + base + "&to=" + head;
                        return [4 /*yield*/, this.get(path)];
                    case 1:
                        res = _a.sent();
                        throwIfNotOk(res);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, comments
                                .filter(function (comment) { return voca_1.default.includes(comment.text, dangerIDMessage); })
                                .filter(function (comment) { return username || comment.author.name === username; })
                                .filter(function (comment) { return voca_1.default.includes(comment.text, bitbucketServerTemplate_1.dangerSignature); })];
                }
            });
        }); };
