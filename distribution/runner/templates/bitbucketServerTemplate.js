...
exports.dangerSignature = "Generated by " + noEntryEmoji + " [dangerJS](http://github.com/danger/danger-js/)";
/**
 * Postfix signature to be attached comment generated / updated by danger.
 */
exports.dangerSignaturePostfix = function (commitID) { return "\n|    |\n|---:|\n| _" + exports.dangerSignature + " against " + commitID + "_ |\n"; };
/**
